...
root = Tk()
root.title("Password Management Application")
root.geometry("600x500")
root.minsize(600, 400)
root.maxsize(600, 400)

frame = Frame(root, bg="#35684E", bd=5)
...
def update():
    ...
    if(t!=""):
        ...
        app_name_label_edit = Label(edit, text="Program or Application Name:")
        app_name_label_edit.grid(row=0, column=0)
        url_label_edit = Label(edit, text="URL of Website:")
...
app_name_label = Label(root, text = "Program or Application Name:")
app_name_label.grid(row=0, column=0)
url_label = Label(root, text = "URL of Website:")
...
submit_btn = Button(root, text = "Add Information", command = submit)
...
delete_btn = Button(root, text = "Delete Information", command = delete)
